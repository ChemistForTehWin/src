...
class EventCaller {
    ...
    public void DoAddAssociatedEvent(Event event) {
        this.associatedEvents.add(event);
    }

    public void DoMakeHappenEventsByID(int EventType) {
        this.associatedEvents.forEach((Event event) -> {
...
class Event {
    ...
    public void DoAttachTriggerAction(TriggerAction triggerAction) {
    ...
    public void onHappen() {
        this.GetTriggerAction().doTrigger();
    }
}
